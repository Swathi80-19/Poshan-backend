...
import com.poshan.backend.dto.ChatAccessRequest;
...
public class MessageController {
    ...
    @PutMapping("/nutritionist/{memberId}/chat-access")
    public MessageThreadResponse updateChatAccess(@PathVariable Long memberId, @RequestBody ChatAccessRequest request) {
        return messageService.updateChatAccess(authContext.requireNutritionistId(), memberId, request.unlocked());
    }
}
